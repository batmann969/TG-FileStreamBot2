...
class Var(object):
    MULTI_CLIENT = False
    API_ID = int(environ.get("20528292"))
    API_HASH = str(environ.get("b3622df89f3f21caa2ea1fa2fb44c0fe"))
    BOT_TOKEN = str(environ.get("6878830879:AAEaDBcXxAIyaZgqOI626TNVJaryKt5xvkc"))
    SLEEP_THRESHOLD = int(environ.get("SLEEP_THRESHOLD", "60"))  # 1 minte
    WORKERS = int(environ.get("WORKERS", "6"))  # 6 workers = 6 commands at once
    BIN_CHANNEL = int(
        environ.get("-4214901590", None)
